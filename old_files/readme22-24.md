...
```sh
Luffy@Luffy:~/Desktop/30DaysOfPython/flask_project$ pip install virtualenv
```

After installing the virtualenv package go to your project folder and create a virtual env by writing:
``sh
Luffy@Luffy:~/Desktop/30DaysOfPython/flask_project\$ virtualenv venv
...
```sh
Luffy@Luffy:~/Desktop/30DaysOfPython/flask_project$ ls
venv/
````
...
```sh
Luffy@Luffy:~/Desktop/30DaysOfPython/flask_project$ source venv/bin/activate
...
```sh
(venv) Luffy@Luffy:~/Desktop/30DaysOfPython/flask_project$
```
...
```sh
(venv) Luffy@Luffy:~/Desktop/30DaysOfPython/flask_project$ pip install Flask
```

Now, let's write pip freeze to see the install packages in the project

```sh
(venv) Luffy@Luffy:~/Desktop/30DaysOfPython/flask_project$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
...
```sh
(venv) Luffy@Luffy:~/Desktop/30DaysOfPython$ deactivate
```
...
[continue](https://github.com/Luffy/30-Days-Of-Python/blob/master/numpy.md)


[<< Part 7 ](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme19-21.md) | [Part 9 >>](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme25-27.md)
