...
```py
  def generate_full_name (first_name, last_name):
      ...
      full_name = first_name + space + last_name
      return full_name
  print('Full Name: ', generate_full_name('Luffy','Monkey'))
...
```py
  def print_fullname(firstname, lastname):
        ...
        print(full_name)
  print_fullname(firstname='Luffy', lastname='Monkey')
...
```py
  def print_name(firstname):
        return firstname
  print_name('Luffy') # Luffy

  def print_full_name(firstname, lastname):
        space = ' '
        full_name = firstname  + space + lastname
        return full_name
  print_full_name(firstname='Luffy', lastname='Monkey')
```
* Returning Number:
...
```py
  ...
  def generate_full_name (first_name = 'Luffy', last_name = 'Monkey'):
      space = ' '
      full_name = first_name + space + last_name
      return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
generate_groups('Team-1','Luffy','Brook','David','Eyob')
```
...
# main.py file
import mymodule
print(mymodule.generate_full_name('Luffy', 'Monkey'))
```
...
output
Welcome Luffy. Enjoy  30DayOfPython challenge!
...
[<< Part 3 ](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme7-9.md) | [Part 5 >>](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme13-15.md)
***
