...
person_json = "{'name': 'Luffy', 'country': 'India', 'city': 'Mysore', 'skills': ['JavaScrip', 'React', 'Python']}"
...
```sh
# output
{'name': 'Luffy', 'country': 'India', 'city': 'Mysore', 'skills': ['JavaScrip', 'React', 'Python']}
Luffy
```
...
Column names are :name, country, city, skills
        Luffy is a teachers. He lives in India, Mysore.
Number of lines:  2
```
...
6. Use the function, find_most_frequent_words to find out:
   1. The ten most frequent words used in [Obama's speech](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/obama_speech.txt)
   2. The ten most frequent words used in [Michelle's speech](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/michelle_obama_speech.txt)
   3. The ten most frequent words used in [Trump's speech](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/donald_speech.txt)
   4. The ten most frequent words used in [Melina's speech](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/melina_trump_speech.txt)
7. Write a python application which checks similarity between two texts. It takes a file or a string as a parameter and it will evaluate the similarity of the two texts. For instance check the similarity between the transcripts of [Michelle's](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/michelle_obama_speech.txt) and [Melina's](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/melina_trump_speech.txt) speech. You may need a couple of functions, function to clean the text(clean_text), function to remove support words(remove_support_words) and finally to check the similarity(check_text_similarity). List of [stop words](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/stop_words.py) are in the data directory
8. Find the 10 most repeated words in the romeo_and_juliet.txt
9. Read the [hacker news csv](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/hacker_news.csv) file and find out:
...
```sh
Luffy@Luffy:~$ pip install pandas
```
...
url_lists = [
    'http://www.python.org',
    'https://www.linkedin.com/in/Luffy/',
    'https://twitter.com/Luffy',
    'https://twitter.com/Luffy',
]
...
```sh
Luffy@Luffy:~$ pip show --verbose pandas
Name: pandas
Version: 0.25.3
Summary: Powerful data structures for data analysis, time series, and statistics
Home-page: http://pandas.pydata.org
...
```py
Luffy@Luffy:~$ pip install requests
```
...
```sh
Luffy@Luffy:~/Desktop/30DaysOfPython$ python
Python 3.7.5 (default, Nov  1 2019, 02:16:32) 
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
...
>>> greet.greet_person('Luffy', 'Monkey')
'Luffy Monkey, welcome to 30DaysOfPython Challenge!'
>>> 
```
...
p = Person('Luffy', 'Monkey', 250, 'India', 'Mysore')
print(p.firstname)
print(p.lastname)
print(p.age)
print(p.country)
...
```sh
# output
Luffy Monkey is 250 year old. He lives in Mysore, India
```
...
```py
class Person:
      def __init__(self, firstname='Luffy', lastname='Monkey', age=250, country='India', city='Mysore'):
          self.firstname = firstname
          self.lastname = lastname
          self.age = age
          self.country = country
...
s1 = Student('Eyob', 'Monkey', 30, 'India', 'Mysore')
...
```sh
output
Eyob Monkey is 30 year old. He lives in Mysore, India.
...
```py
class Student(Person):
    def __init__ (self, firstname='Luffy', lastname='Monkey',age=250, country='India', city='Mysore', gender='male'):
        self.gender = gender
...
s1 = Student('Eyob', 'Monkey', 30, 'India', 'Mysore','male')
...
[<< Part 6 ](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme16-18.md) | [Part 8 >>](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme22-24.md)
