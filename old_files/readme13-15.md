...
1. Change the following list to a flatten list:
   ```py
   countries = [[('India', 'Mysore')], [('Sweden', 'Stockholm')], [('Norway', 'Oslo')]]
   output:
   ['India', 'Mysore', 'SWEDEN', 'STOCKHOLM', 'NORWAY', 'OSLO']
   ```
...
1. Change the following list of lists to flat list:
   ```py
   names = [[('Luffy', 'Yetaeyeh')], [('David', 'Smith')], [('Donald', 'Trump')], [('Bill', 'Gates')]]
   output
   ['Luffy Yetaeyeh', 'David Smith', 'Donald Trump', 'Bill Gates']
   ```
...
print_full_name("Luffy", "Monkey",'India')
```
...
```py
names = ['Luffy', 'Lidiya', 'Ermias', 'Abraham']  # iterable

def change_to_upper(name):
    return name.upper()

names_upper_cased = map(change_to_upper, names)
print(list(names_upper_cased))    # ['Luffy', 'LIDIYA', 'ERMIAS', 'ABRAHAM']
...
names = ['Luffy', 'Lidiya', 'Ermias', 'Abraham']
...
1. Declare a function called categorize_countries which returns an list of countries which have some common pattern(you find the [countries list](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/countries.py) in this repository as countries.js(eg 'land', 'ia', 'island', 'stan')).
...
1. Find out which letter is used many times as initial for a country name from the [countries list](https://github.com/Luffy/30-Days-Of-Python/blob/master/data/countries-data.py)(eg. India, Fiji, France etc)
...
[<< Part 4 ](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme10-12.md) | [Part 6 >>](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme16-18.md)
