...
print(sentence) # I am Luffy Monkey. I am a teacher. I live in India.
...
```py
 lst = ['Luffy', 250, True, {'country':'India', 'city':'Mysore'}] # list containing different data types
```
...
29. Find the middle country(ies) in the [countries list](https://github.com/Luffy/30-Days-Of-Python/tree/master/data/countries.py)
...
[<< Part 1](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme.md) | [Part 3>>](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme7-9.md)