...
```py
{'name':'Luffy', 'country':'India', age:250, 'is_married':True}
```
...
print(type('Luffy'))  # String
print(type([1, 2, 3]))   # List
print(type({'name':'Luffy'})) # Dictionary
...
```py
first_name, last_name, country, age, is_married = 'Luffy', 'Monkey', 'Helsink', 250, True
...
first_name = 'Luffy'     # str
last_name = 'Monkey'       # str
country = 'India'         # str
city= 'Mysore'            # str
age = 250                   # int, it is not my real age, don't worry about it

# Printing out types
print(type('Luffy'))     # str
...
print(type({'name':'Luffy','age':250, 'is_married':250}))    # dict
...
print('A in Luffy', 'A' in 'Luffy') # True - A found in the string
print('B in Luffy', 'B' in 'Luffy') # False -there is no uppercase B
...
[Part 2 >>](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme4-6.md)
