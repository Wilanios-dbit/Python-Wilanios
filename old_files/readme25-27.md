...
```python
dct = {'name':'Luffy','country':'India','city':'Mysore'}
```
...
```python
data = {'Name': ['Luffy', 'David', 'John'], 'Country':[
...
```python
data = [
    {'Name': 'Luffy', 'Country': 'India', 'City': 'Mysore'},
...
```sh
Luffy@Luffy:~/Desktop$ mkdir python_for_web
Luffy@Luffy:~/Desktop$ cd python_for_web/
Luffy@Luffy:~/Desktop/python_for_web$ virtualenv env
Luffy@Luffy:~/Desktop/python_for_web$ source env/bin/activate
(env) Luffy@Luffy:~/Desktop/python_for_web$ pip freeze
(env) Luffy@Luffy:~/Desktop/python_for_web$ pip install Flask
(env) Luffy@Luffy:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Luffy@Luffy:~/Desktop/python_for_web$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Luffy@Luffy:~/Desktop/python_for_web$ touch requirements.txt
(env) Luffy@Luffy:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) Luffy@Luffy:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Luffy@Luffy:~/Desktop/python_for_web$ touch Procfile
(env) Luffy@Luffy:~/Desktop/python_for_web$ ls
Procfile          env/              static/
...
```sh
mongodb+srv://Luffy:<password>@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
```sh
mongodb+srv://Luffy:123123123@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority
```
...
from flask import Flask, render_template
import os # importing operating system module
MONGODB_URI = 'mongodb+srv://Luffy:your_password_goes_here@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority'
...
db.students.insert_one({'name': 'Luffy', 'country': 'India', 'city': 'Mysore', 'age': 250})
print(client.list_database_names())
...
students = [
        ...
        {'name':'Sami','country':'India','city':'Mysore','age':25},
    ]
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Luffy', 'country': 'Mysore', 'city': 'Mysore', 'age': 250}
```
...
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'India', 'city': 'Mysore', 'age': 25}
```
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Luffy', 'country': 'India', 'city': 'Mysore', 'age': 250}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'India', 'city': 'Mysore', 'age': 25}
```
...
The first person, Luffy got a very implausible age. Let's update Luffy's age.
...
```sh
{'_id': ObjectId('5df68a21f106fe2d315bbc8b'), 'name': 'Luffy', 'country': 'India', 'city': 'Mysore', 'age': 38}
{'_id': ObjectId('5df68a23f106fe2d315bbc8c'), 'name': 'David', 'country': 'UK', 'city': 'London', 'age': 34}
{'_id': ObjectId('5df68a23f106fe2d315bbc8d'), 'name': 'John', 'country': 'Sweden', 'city': 'Stockholm', 'age': 28}
{'_id': ObjectId('5df68a23f106fe2d315bbc8e'), 'name': 'Sami', 'country': 'India', 'city': 'Mysore', 'age': 25}
```
...
[<< Part 8 ](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme22-24.md) | [Part 10 >>](https://github.com/Luffy/30-Days-Of-Python/blob/master/readme28-30.md)
